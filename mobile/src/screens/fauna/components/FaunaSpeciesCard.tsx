/**
 * FaunaSpeciesCard Component
 *
 * Expandable card for displaying animal species information.
...
export function FaunaSpeciesCard({
  species,
  language,
  criticalTag,
}: FaunaSpeciesCardProps): React.JSX.Element {
...
export default FaunaSpeciesCard;
