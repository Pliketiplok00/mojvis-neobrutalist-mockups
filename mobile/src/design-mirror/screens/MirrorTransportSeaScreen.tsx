/**
 * Mirror Sea Transport Screen
 *
 * Dev-only mirror of SeaTransportScreen.
...
export function MirrorTransportSeaScreen(): React.JSX.Element {
  ...
  const handleLinePress = (lineId: string) => {
    console.log('[MirrorTransportSea] Line pressed:', lineId);
  };
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.headerBar}>
        ...
        <Label style={styles.headerBarLabel}>Mirror: Sea Transport</Label>
      </View>
        ...
        <View style={styles.headerSlab}>
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerTextContainer}>
              <H1 style={styles.headerTitle}>Pomorski prijevoz</H1>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.todaySetWrapper}>
            ...
            <View style={styles.todaySet}>
              {seaTodayDeparturesFixture.map((dep, index) => (
                <Pressable
...
const styles = StyleSheet.create({
  ...
  todayTimeBlock: {
    ...
    backgroundColor: listTokens.todayTimeBlockBackgroundSea,
...
export default MirrorTransportSeaScreen;
